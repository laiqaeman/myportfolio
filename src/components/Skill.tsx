...
const Skill = () => {
  ...
  <h2
    className="text-3xl sm:text-4xl md:text-5xl text-center pb-2 mx-auto relative -top-6 border-b-4 w-max"
  ...
  >
    Technologies I Work With
      ...
      <div className="border-2 border-sky-500 p-8 rounded-lg">
        ...
        {/* Skill Set */}
        <div className="mt-8 flex justify-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-blue-500 text-3xl sm:text-4xl">
